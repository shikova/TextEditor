    ...
    private void find(String pattern) {
        if (!finishedFinding) {
            if (matcher.find()) {
                ...
                parent.getText_area().getTextArea().moveCaretPosition(matcher.start());
                parent.getText_area().getTextArea().select(selectionStart, selectionEnd);
            } else {
            ...
            matcher = Pattern.compile(pattern).matcher(parent.getText_area().getTextArea().getText());
